...
async function testTexture() {
  ...
  const demoShowTexture = (window.demoShowTexture = new ShowTexture(
    colorMap.length,
    200
  ));
...
async function matrixJob(dimensions) {
  ...
  if (dimensions < 10) {
    ...
    const demoMatrixUniform = (window.demoMatrixUniform = new MatrixUniform(
      dimensions
    ));
  ...
  const demoMatrixTexture = (window.demoMatrixTexture = new MatrixTexture(
    dimensions
  ));
...
async function matrixCost(dimensions) {
  ...
  const costdemoMatrixTexture = (window.costdemoMatrixTexture = new MatrixTextureForCost(
    dimensions
  ));
